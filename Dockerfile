...
RUN wget https://downloads.apache.org/tomcat/tomcat-8/v8.5.63/bin/apache-tomcat-8.5.63.tar.gz
RUN tar -zxvf apache-tomcat-8.5.63.tar.gz -C /opt/tomcat --strip-components=1
